...
<body>
    ...
    <div class="center-body">
        ...
        <div class="tea">
            <img src="teacher.png" alt="Teachers">
            <h3>Teachers</h3>
            <div class="tcount">
                <h5>225,400</h5>
            </div>
    ...
    <div class="line">
        <h1>If you educate people, you can turn the world upside down.</h1>
    </div>

    <div class="find-school">
        <p>Find your School :<a href="find-school.html" style="text-decoration: none;"> Click</a></p>
    </div>
    <hr>
    <div class="tnschool">TN Schools</div>
    <div class="schooldetail">
        <p>In TamilNadu there are 37554 Schools. 12084 Governtment Aided Schools, 12683 Private Schools and 684 CBSE Schools. The EduSite for Smart School (ESSS) project aims to create a centralized online platform that showcases information about schools in Tamil Nadu. The platform allows schools to provide their details, which are then displayed on the website, making it easily accessible to the public. This project bridges the information gap between schools and stakeholders, including parents, students, and educators.</p>
    </div>
    ...
    <div class="container" id="signUp" style="display: none;">
        ...
        <form method="post" action="register.php">
            <div class="input-group">
                ...
                <label for="fname">School First Name</label>
            </div>
            <div class="input-group">
                <i class="fas fa-user"></i>
                <input type="text" name="lname" class="lname" placeholder="Last Name" required>
                <label for="lname">School Last Name</label>
            </div>
            <div class="input-group">
        ...
        <div class="icons">
            <a href="student_loginpage.php">Student Login</a>
        </div>
        <div class="links">
    ...
    <div class="container" id="signIn" style="display: none;">
        ...
        <div class="icons">
        <a href="student_loginpage.php">Student Sign Up</a>
        </div>
        <div class="links">
